...
namespace MovieApp.EntityFramework
{
    public class MovieAppDbContext : DbContext
    {
        ...
        private const string _remoteDbConnectionString = "Server=tcp:dimden.database.windows.net,1433;Initial Catalog=MovieAppDB;Persist Security Info=False;User ID=some;Password=secret; MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
